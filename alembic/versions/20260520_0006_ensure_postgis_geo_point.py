"""ensure optional postgis geo point
...
def upgrade() -> None:
    op.execute(
        ...
        EXCEPTION
            WHEN OTHERS THEN
                RAISE NOTICE 'PostGIS extension is not available for this database role/image; keeping numeric coordinate fallback. Error: %', SQLERRM;
        END
        $$;
        """
    )
